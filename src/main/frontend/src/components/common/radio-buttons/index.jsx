...
export class RadioGroup extends Component {
	...
	render() {
		...
		return (
			<div style={style} {...props} className="radio-group-wrapper">
				{
...
export class RadioButton extends Component {
	...
	getStyles() {
		const {horizontal, last, padding, rootColor, pointColor, disabled, disabledColor, label, hasTooltip, dataId, dataTooltip} = this.props;
	...
	render() {
		const {checked, iconSize, iconInnerSize, rootColor, pointColor, children, disabled, disabledColor, label, hasTooltip, dataId, dataTooltip} = this.props;
		...
		return (
			...
			<div style={buttonStyle} onClick={this.onClick} data-tip={dataTooltip} data-for={dataId} className="radio-button-wrapper">
				...
				{hasTooltip && <ReactTooltip id={dataId}/>}
			</div>
		);
	}
}
...
export class RadioIcon extends Component {
	...
	render() {
		...
		return (
			<div style={iconStyle} className="radio-button-icon">
