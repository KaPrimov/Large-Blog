...
var DanteInlineTooltip = function (_React$Component) {
	...
	DanteInlineTooltip.prototype.handleFileInput = function handleFileInput(e) {
		...
		if (fileList[0].size > Configuration.MAX_FILE_UPLOAD_SIZE_IN_BYTES) {
			NotificationService.notifyError(I18n.t('temp_file_actions.upload_file_too_big'));
			return () => {}; 
		}
    ...
    */
	...
	DanteInlineTooltip.prototype.relocate = function relocate() {
		...
		if (editorState.getSelection().isCollapsed()) {
			...
			return this.setPosition({
				top: coords.top + window.scrollY - 220,
				left: coords.left + window.scrollX - 200
			});
	...
	DanteInlineTooltip.prototype.render = function render() {
		var _this2 = this;
		if (_this2.props.configTooltip.isTooltipHidden) {
			return null;
		}
